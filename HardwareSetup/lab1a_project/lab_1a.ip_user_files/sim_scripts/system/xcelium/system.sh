...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../lab_1a.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../lab_1a.srcs/sources_1/bd/system/ipshared/1ddd/hdl/verilog" \
       +incdir+"$ref_dir/../../../../lab_1a.srcs/sources_1/bd/system/ipshared/b2d0/hdl/verilog" \
       +incdir+"../../../../lab_1a.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../lab_1a.srcs/sources_1/bd/system/ipshared/1ddd/hdl/verilog" \
       +incdir+"../../../../lab_1a.srcs/sources_1/bd/system/ipshared/b2d0/hdl/verilog" \
