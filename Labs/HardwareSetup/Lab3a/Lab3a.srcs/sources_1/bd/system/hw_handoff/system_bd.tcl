...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins axi_gpio_RGB/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins axi_gpio_encoder/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M10_AXI [get_bd_intf_pins SPI/AXI_LITE] [get_bd_intf_pins microblaze_0_axi_periph/M10_AXI]
  ...
  connect_bd_net -net axi_gpio_encoder_ip2intc_irpt [get_bd_pins axi_gpio_encoder/ip2intc_irpt] [get_bd_pins microblaze_0_xlconcat/In4]
  connect_bd_net -net axi_gpio_led_6bit_gpio_io_o [get_bd_ports rgbleds] [get_bd_pins axi_gpio_RGB/gpio_io_o]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins SPI/ext_spi_clk] [get_bd_pins clk_wiz_0/clk_out1]
  ...
  connect_bd_net -net sys_rst_0_1 [get_bd_ports btnCpuReset] [get_bd_ports reset_spi] [get_bd_pins mig_7series_0/sys_rst]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40030000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_encoder/S_AXI/Reg] SEG_axi_gpio_encoder_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40020000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_RGB/S_AXI/Reg] SEG_axi_gpio_led_6bit_Reg
