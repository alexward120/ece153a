...
void performanceAnalyzer()
{
	...
	if(a >= 0x8000e814 && a < 0x8000f15c) //8000e814 to 8000f15c
	{
		Performance.fft++;
	}
	else if ( a >= 0x8000f30c && a < 0x8000f490) //8000f30c to 8000f490
	{
		Performance.read_fsl_values++;
	}
	else if ( a >= 0x8000f64c && a < 0x8000fa30) //8000f64c to 8000fa7c
	{
		Performance.main++;
	}
	else if ( a >= 0x8000fa34 && a < 0x8000fc24) //8000fa80 to 8000fc70
	{
